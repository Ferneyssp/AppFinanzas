...
/// Permite editar descripción, categoría, monto y fecha de un egreso
/// existente, re-validando el límite de saldo (excluyendo el monto
/// original del cálculo, tal como exige la regla de negocio).
class EditExpenseScreen extends StatefulWidget {
  final Movimiento movimiento;

  const EditExpenseScreen({super.key, required this.movimiento});
...
class _EditExpenseScreenState extends State<EditExpenseScreen> {
  ...
  Future<void> _guardar() async {
    ...
    final resultado = await finanzas.intentarActualizarEgreso(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Editar egreso')),
      body: Form(
        key: _formKey,
        child: ListView(
